...
class SearchScreenTest {
    ...
    @Test
    fun test_initialState() = RUN_UI_TEST(robot) {
    ...
    @Test
    fun test_loadingState() = RUN_UI_TEST(robot) {
    ...
    @Test
    fun test_userListState() = RUN_UI_TEST(robot) {
    ...
    @Test
    fun test_usersNotFoundState() = RUN_UI_TEST(robot) {
    ...
    @Test
    fun test_errorState() = RUN_UI_TEST(robot) {
    ...
    @Test
    fun test_errorWhenListHasDataState() = RUN_UI_TEST(robot) {
