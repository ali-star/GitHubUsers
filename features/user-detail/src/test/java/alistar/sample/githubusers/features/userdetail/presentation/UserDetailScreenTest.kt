...
class UserDetailScreenTest {
    ...
    @Test
    fun test_resultState() = RUN_UI_TEST(robot) {
    ...
    @Test
    fun test_navigateBack() = RUN_UI_TEST(robot) {
        GIVEN { mockGetUserDetailUseCaseWithSuccessResult() }
        WHEN { createViewModel() }
        AND { createUserDetailScreen() }
    ...
    @Test
    fun test_openTwitterLink() = RUN_UI_TEST(robot) {
    ...
    @Test
    fun test_openBlogLink() = RUN_UI_TEST(robot) {
